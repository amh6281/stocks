...
<head>
    ...
    <title>Signalist에 오신 것을 환영합니다</title>
    <!--[if mso]>
    <noscript>
        <xml>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <ul class="mobile-text dark-text-secondary" style="margin: 0 0 30px 0; padding-left: 20px; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                <li style="margin-bottom: 12px;">관심 종목을 추가해 관심 목록을 만들어보세요</li>
                                <li style="margin-bottom: 12px;">가격 및 거래량 알림을 설정해 중요한 움직임을 놓치지 마세요</li>
                                <li style="margin-bottom: 12px;">대시보드에서 트렌드와 최신 시장 뉴스를 확인하세요</li>
                            </ul>
                            
                            <!-- Additional Text -->
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 40px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                시의적절한 업데이트, 인사이트, 알림을 제공해 드리니 올바른 투자 결정에 집중하실 수 있습니다.
                            </p>
                            ...
                            <p class="mobile-text dark-text-muted" style="margin: 40px 0 0 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important; text-align: center;">
                               Signalist 본사, 200 Market Street, San Francisco, CA 94105<br>
                                <a href="#" style="color: #CCDADC !important; text-decoration: underline;">구독 취소</a> | 
                                <a href="https://stock-market-dev.vercel.app/" style="color: #CCDADC !important; text-decoration: underline;">Signalist 방문하기</a><br>
                                © 2025 Signalist
                            </p>
                        </td>
                    </tr>
                        ...
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    Signalist 뉴스 업데이트를 구독하셔서 이 메일을 받고 계십니다.
                                </p>
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    <a href="#" style="color: #CCDADC !important; text-decoration: underline;">구독 취소</a> | 
                                    <a href="https://signalist.app" style="color: #CCDADC !important; text-decoration: underline;">Signalist 방문하기</a>
                                </p>
...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
    <meta name="x-apple-disable-message-reformatting">
    <title>가격 알림: {{symbol}} 상한가 도달</title>
    <!--[if mso]>
    <noscript>
        <xml>
            <o:OfficeDocumentSettings>
                        ...
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <div class="dark-info-box" style="background-color: #212328; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text dark-text-secondary" style="margin: 0 0 10px 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>목표가:</strong> {{targetPrice}}
                                </p>
                                <p class="mobile-text dark-text-secondary" style="margin: 0 0 10px 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>발동 조건:</strong> 가격이 상한 목표가 {{targetPrice}}를 초과했습니다
                                </p>
                            </div>
                            ...
                            <div style="background-color: #050505; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text" style="margin: 0; font-size: 14px; line-height: 1.5; color: #ccdadc;">
                                    {{symbol}}이(가) 목표가에 도달했습니다! 포지션을 검토하고 수익 실현 또는 전략 조정을 고려해볼 좋은 시기일 수 있습니다.
                                </p>
                            </div>
...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
    <meta name="x-apple-disable-message-reformatting">
    <title>가격 알림: {{symbol}} 하한가 도달</title>
    <!--[if mso]>
    <noscript>
        <xml>
            <o:OfficeDocumentSettings>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <div class="dark-info-box" style="background-color: #212328; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text dark-text-secondary" style="margin: 0 0 10px 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>발동 조건:</strong> 가격이 하한 목표가 {{targetPrice}} 아래로 하락했습니다
                                </p>
                            </div>
                            ...
                            <div style="background-color: #050505; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text" style="margin: 0; font-size: 14px; line-height: 1.5; color: #ccdadc;">
                                    {{symbol}}이(가) 목표가 아래로 하락했습니다. 매수 고려 시점일 수 있습니다.
                                </p>
                            </div>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <div class="dark-info-box" style="background-color: #1f2937; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text dark-text-secondary" style="margin: 0 0 10px 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>발동 조건:</strong> {{alertMessage}}
                                </p>
                                <p class="mobile-text dark-text-secondary" style="margin: 0 0 10px 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>평균 거래량:</strong> {{averageVolume}}M주
                                </p>
                                <p class="mobile-text dark-text-secondary" style="margin: 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>급증 감지:</strong> 평소 거래량 대비 {{volumeSpike}} 증가
                                </p>
                            </div>
                            ...
                            <div class="dark-info-box" style="background-color: #1f2937; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text dark-text-secondary" style="margin: 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    높은 거래량은 종종 투자자 관심 증가, 잠재적 뉴스 이벤트, 또는 중요한 가격 변동을 나타냅니다. 이러한 활동을 주도하는 요인을 조사해볼 기회일 수 있습니다.
                                </p>
                            </div>
                            ...
                            <div class="dark-info-box" style="background-color: #1f2937; border-radius: 6px; padding: 15px; margin-bottom: 20px; border: 1px solid #374151;">
                                <p class="dark-text-muted" style="margin: 0; font-size: 13px; line-height: 1.4; color: #6b7280; text-align: center;">
                                    <strong>면책 조항:</strong> 이 알림은 정보 제공 목적으로만 제공되며 투자 조언으로 간주되어서는 안 됩니다. 높은 거래량이 가격 방향을 보장하지는 않습니다. 투자 결정 전 항상 본인의 조사를 수행하세요.
                                </p>
                            </div>
...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
    <meta name="x-apple-disable-message-reformatting">
    <title>다시 만나뵙고 싶습니다! 시장 인사이트가 기다리고 있습니다</title>
    <!--[if mso]>
    <noscript>
        <xml>
            <o:OfficeDocumentSettings>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                Signalist를 방문하지 않으신 지 꽤 되었네요. 시장이 움직이고 있고, 놓치고 싶지 않은 기회가 있을 수 있습니다!
                            </p>
                            ...
                            <div class="dark-info-box" style="background-color: #050505; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text" style="margin: 0; font-size: 14px; line-height: 1.5; color: #ccdadc;">
                                    최근 시장이 활발하게 움직이고 있습니다! 주요 지수들이 큰 변동을 보였고, 관심 종목에 놓치고 싶지 않은 기회가 있을 수 있습니다.
                                </p>
                            </div>
                            
                            <!-- Encouragement Message -->
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 40px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                관심 목록은 여전히 활성화되어 있어 투자 현황을 파악하는 데 도움이 됩니다. 시장 기회를 놓치지 마세요!
                            </p>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    궁금한 점이 있으신가요? 이메일로 답장하시거나 고객 지원팀에 문의해 주세요.
                                </p>
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    <a href="{{unsubscribeUrl}}" style="color: #CCDADC !important; text-decoration: underline;">구독 취소</a> | 
                                    <a href="{{dashboardUrl}}" style="color: #CCDADC !important; text-decoration: underline;">Signalist 방문하기</a>
                                </p>
                                <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    © 2025 Signalist
                                </p>
